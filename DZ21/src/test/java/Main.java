...
public class Main {
    ...
    public void firstTest() throws InterruptedException {
        ...
        driver.findElement(By.id("signupName")) .sendKeys("Jeka");
        driver.findElement(By.id("signupLastName")) .sendKeys("Alexandrov");
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath(".//*[text()='Jeka Alexandrov']"));
        Assert.assertEquals("not match", "Jeka Alexandrov", "Jeka Alexandrov");
        Thread.sleep(2000);
        ...
        driver.findElement(By.id("addExpenseMileage")) .sendKeys("1500");
        Thread.sleep(2000);
