...
(function($) {
    ...
    hero_s.owlCarousel({
        ...
        animateOut: 'fadeOut',
    	animateIn: 'fadeIn',
        navText: ['<img src="./image/angle-left-w.png" alt="">', '<img src="./image/angle-rignt.png" alt="">'],
        smartSpeed: 1200,
        autoHeight: false,
	...
	$('.gallery-single-slider').owlCarousel({
        ...
        items: 1,
        dots: false,
        navText: ['<img src="./image/angle-left.png" alt="">', '<img src="./image/angle-rignt-w.png" alt="">'],
	});
