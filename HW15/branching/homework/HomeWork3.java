    ...
    public static void main(String[] args) {
        ...
        switch (paymentType) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Оплата за рахунком, сума з комісією складає " + payment * paymentInvoice + " грн.");

                break;
            default:
                System.out.println("Такого способу оплати немає. Виберіть інший спосіб оплати.");
        }
    }
}
